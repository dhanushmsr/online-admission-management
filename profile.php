                            ...
                            <div>
                                <div class="feed-activity-list">
									...
									<div class="feed-element">
                                        ...
                                        <div class="media-body ">
                                            <small class="pull-right text-navy"></small>
                                            <strong>City :</strong>                    <?php echo $rowaccess['lga'];   ?> <strong> <br>
                                        </div>
                                    </div>
									<div class="feed-element">
                                        <a href="#" class="pull-left">
									...
									<div class="feed-element">
                                        ...
                                        <div class="media-body ">
                                            <small class="pull-right text-navy"></small>
                                            <strong>Jamb Number :</strong>                    <?php echo $rowaccess['jamb_number'];   ?><strong>  <br>
                                        </div>
                                    </div>
                                  <div class="feed-element">
                                        <a href="#" class="pull-left">
                                        ...
                                        <div class="media-body ">
                                            <small class="pull-right text-navy"></small>
                                            <strong>Jamb Score :</strong>                    <?php echo $rowaccess['jamb_score'];   ?> <strong> <br>
                                        </div>
                                    </div>
									 <div class="feed-element">
                                        <a href="#" class="pull-left">
									 ...
									 <div class="feed-element">
                                        ...
                                        <div class="media-body ">
                                            <small class="pull-right text-navy"></small>
                                            <strong>SSCE DETAILS :</strong>                    <?php echo $rowaccess['ssce_details'];   ?>  <br>
                                        </div>
                                    </div>
                                </div>
